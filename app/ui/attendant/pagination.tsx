...
function PaginationNumber({
  ...
  const className = clsx(
    'flex h-10 w-10 items-center justify-center text-sm border',
    {
      ...
      'z-10 bg-yellow-600 border-yellow-500 text-white': currentUserClub === 'faisca' && isActive,
      'z-10 bg-green-600 border-green-500 text-white': currentUserClub === 'flama' && isActive,
      'z-10 bg-blue-600 border-blue-500 text-white': currentUserClub === 'tocha' && isActive,
      'z-10 bg-gray-300 border-gray-200 text-black': currentUserClub === 'jv' && isActive,
      'z-10 bg-gray-600 border-gray-500 text-white': currentUserClub === 'vq7' && isActive,
